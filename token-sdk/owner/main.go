...
import (
	...
	"github.com/hyperledger/fabric-and-gateway-usages/token-sdk/owner/routes"
	"github.com/hyperledger/fabric-and-gateway-usages/token-sdk/owner/service"
...
func main() {
	...
	succeedOrPanic(registry.RegisterResponder(&service.AcceptCashView{}, "github.com/hyperledger/fabric-and-gateway-usages/token-sdk/issuer/service/IssueCashView"))
