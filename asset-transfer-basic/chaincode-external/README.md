...
Open the `config/core.yaml` file at the top of the `fabric-and-gateway-usages` directory. If you do not have this file, follow the instructions to [Install the Samples, Binaries and Docker Images](https://hyperledger-fabric.readthedocs.io/en/latest/install.html) to download the Fabric binaries and configuration files alongside the Fabric samples.

Modify the `externalBuilders` field in the `core.yaml` file to resemble the configuration below:

```
externalBuilders:
    - path: /opt/gopath/src/github.com/hyperledger/fabric-and-gateway-usages/asset-transfer-basic/chaincode-external/sampleBuilder
...
```
        - ../..:/opt/gopath/src/github.com/hyperledger/fabric-and-gateway-usages
...
Open a new terminal and navigate to the `fabric-and-gateway-usages/asset-transfer-basic/chaincode-external` directory.

```
cd fabric-and-gateway-usages/asset-transfer-basic/chaincode-external
```
...
We will use the Fabric test network to run the external chaincode. Open a new terminal and navigate to the `fabric-and-gateway-usages/test-network` directory.
...
Open yet another terminal and navigate to the `fabric-and-gateway-usages/asset-transfer-basic/application-gateway-go` directory:

```
cd fabric-and-gateway-usages/asset-transfer-basic/application-gateway-go
```
...
- As a first step generate a keypair that can be used. Run these commands from the `fabric-and-gateway-usages/asset-transfer-basic/chaincode-external` directory.
